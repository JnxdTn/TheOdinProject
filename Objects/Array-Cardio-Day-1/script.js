...
const filterBornIn1500 = inventors.filter((element) => {
...
const inventorsFullNames = inventors.map((element) => `${element.first} ${element.last}`);
...
console.table(inventors.sort((firstPerson, secondPerson) => {
...
console.table(inventors.sort((firstPerson, nextPerson)=>{
    const firstInventor = firstPerson.passed - firstPerson.year;
    const nextInventor = nextPerson.passed - nextPerson.year; 
...
const sortLastNameAlphabetically = people.sort();
